    ...
    return (
        <>
            <header>
                ...
                <nav>
                    <ul>
                        <ListItems items={[<LinkTo external={false} href="#about-me" text="About Me"/>,
                        <LinkTo external={false} href="#fav-foods" text="Favourite Foods"/>,
                        <LinkTo external={false} href="#contact" text="Contact Details"/>]}/>
                    </ul>
                </nav>
            </header>
            ...
            <Section name="fav-foods" heading="My Fav foods" children={
                <>
